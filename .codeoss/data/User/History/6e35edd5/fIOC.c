...
int main(int argc, char *argv[]) {
    ...
    if (pid == 0) {
        ...
        exec("/bin/ls");
        // There is no function named just "exec". It's a family of functions.
        // Let's use execl(). The first argument is the path to the
        // executable, the second is conventionally the program name, and it's
